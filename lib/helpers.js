...
function withTunnelStatus(configVars, options={}, callback) {
...
function withTunnelInfo(dyno, configVars, options={}, callback) {
  var rawTunnelsUrl = _getTunnelsUrl(configVars)
  var tunnelsUrl = url.parse(rawTunnelsUrl)
  var dyno = dyno || _getTunnelsDyno(configVars)
...
function updateClientKey(dyno, configVars, callback) {
...
function createSocksProxy(dyno, configVars, callback) {
  return updateClientKey(dyno, configVars, function(key, dyno, response) {
